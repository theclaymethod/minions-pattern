...
| Planner escalation | Fable Max | Sol Max | Genuinely difficult planning after High is insufficient |
...
Never select Ultra. Keep fast mode off unless the user explicitly values latency over quota.
...
- Use Max only when task difficulty justifies it.
